...
router.post('/sent/:id/reply', replyToMailboxMessage);
...
router.delete('/sent/:id', deleteMailboxMessage);
router.get('/inbox/:id/attachments/:attachmentId/download', downloadMailboxAttachment);
router.get('/inbox/:id', getMailboxMessage);
router.get('/sent/:id/attachments/:attachmentId/download', downloadMailboxAttachment);
router.get('/sent/:id', getMailboxMessage);
