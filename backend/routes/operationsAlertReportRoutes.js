...
const { getAlertComplianceReport, listAlertComments, addAlertComment, resolveAlertManually, updateTicketStatus, updateIncidentSubstatus, deleteAlert, getAlertMessage } = require('../controllers/operationsAlertReportController');
...
router.post('/incident-substatus', requirePermission('view_alert_compliance_report'), updateIncidentSubstatus);
