...
test('manage_customer_csm has a display label and defaults to the admin role only', () => {
  ...
  assert.match(frontend, /'manage_users', 'manage_roles', 'assign_roles', 'manage_data', 'manage_customer_csm', 'view_alert_compliance_report', 'delete_alert_compliance_alerts'\]/);
});
